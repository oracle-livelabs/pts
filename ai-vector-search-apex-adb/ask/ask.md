...
In this workshop we showcased an AI RAG application using Oracle APEX, Oracle AI Database 26ai with AI Vector Search, and the Oracle Cloud Object Storage. These products and services are important building blocks for many AI solutions.
