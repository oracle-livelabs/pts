...
13. Run this code to create a new Access Control List (ACL) so the DBAI user can connect to the `oraclecloud.com` domain.
...
14. On the Oracle Cloud Console, on your ADB instance page, under the Tool Configuration tab, you will use APEX for the AI Vector Search and RAG application.
...
16. Paste your APEX URL in a new tab of your browser. 
...
21. Use these attributes for the new Workspace. Use the same strong password the ADB admin user has.
...
7. Review and click Install Application.
...
15. Create an OCI native credential. This credential will be used to communicate with OCI Generative AI services.
...
18. Import `all_MiniLM_L12_v2.onnx` large language model (LLM) into your ADB instance from the object storage bucket.
...
3. Do not ask any questions at this time. There are still some details to fix before it works.
...
6. Use the Search bar at the top of the APEX development environment to search and replace some strings in the application code.

    ![application dev](./images/application-dev.png " ")

7. Set the correct Compartment OCID in the application. Search this App for `here_use_your_own_compartment_ocid` string.

    ![here use your compartment ocid](./images/here-use-your-compartment-ocid.png " ")

8. Click View under every result to access the code in the application.
...
17. Name it OBJAPI. Use the following details and your values to create the Web Credentials.
...
1. On the QandA application, click the DBAIADMIN user link > Sign Out.
...
4. This page is called Home.

    ![qanda home](./images/qanda-home.png " ")

5. Download oracle-database-23ai-new-features-guide.pdf from Oracle Database documentation: https://docs.oracle.com/en/database/oracle/oracle-database/23/nfcoa/oracle-database-23ai-new-features-guide.pdf

6. Click the QandA main menu. Click Upload.

    ![qanda upload](./images/qanda-upload.png " ")

7. Upload the oracle-database-23ai-new-features-guide.pdf file via the sample application on your Object Storage bucket.

    ![upload pdf](./images/upload-pdf.png " ")

8. You can see the files uploaded in your Bucket on the Upload page.
...
10. Import oracle-database-23ai-new-features-guide.pdf
...
12. Click Vectors. Select oracle-database-23ai-new-features-guide.pdf and click Embed.

    ![qanda vectors](./images/qanda-vectors.png " ")

13. The embedding process, called vectorization, runs in the background. You can wait and click the Refresh button for updates.

    ![embedding document](./images/embedding-document.png " ")

14. After the document is vectorized, it is listed in the report that shows all vectorized documents in your `VECTORS` table with the corresponding number of vectors. This document generated 226 vectors during the embedding process.
...
16. Ask the same question on the Test page: What are the new features in Oracle Database 23ai? As you have new embedded documents, in other words, vectors that can be used to perform a similarity search for your question and build a better context for the prompt sent to the OCI Generative AI services, the answer may differ from the first one. The idea is to improve the answers with the embedded documents available in the database.

    ![test ask question](./images/test-ask-question.png " ")

17. The Test page also lists the documents and their corresponding chunks that are closer as vectors to the question based on the similarity search distance.

    ![test proximity vectors](./images/test-proximity-vectors.png " ")

18. Click Users. This page can be used to manage application users.

    ![qanda users](./images/qanda-users.png " ")

19. Click Dialog. This is a complete report of all questions asked in the application and their answers. Check if the context provided was enough to generate a correct answer. If not, add more documents to the repository.

    ![qanda dialog](./images/qanda-dialog.png " ")

20. On OCI Cloud Console, you can see the uploaded PDF documents in the Object Storage Bucket.
