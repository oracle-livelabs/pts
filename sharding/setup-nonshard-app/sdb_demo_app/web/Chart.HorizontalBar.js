        ...
        calculateBaseHeight : function(){
				...
				calculateBarY : function(datasetCount, datasetIndex, barIndex){
					//Reusable method for calculating the yPosition of a given bar based on datasetIndex & height of the bar
					  var h = (this.endPoint - this.startPoint) / this.yLabels.length;
            var baseHeight = h - 2 * options.barValueSpacing;
						var barHeight = (baseHeight - (datasetCount - 1) * options.barDatasetSpacing) / datasetCount;
            var y = this.startPoint + barIndex * h + options.barValueSpacing + barHeight/2 + (barHeight + options.barDatasetSpacing) * datasetIndex;
					  return y;
				},
