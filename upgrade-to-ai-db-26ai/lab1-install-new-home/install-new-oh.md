...
- Learn how to install and register a new Oracle AI Database Home in the location of your choice
- Install the Oracle AI Database preinstall package
- Create a new Oracle AI Database Container Database (CDB) with a pluggable database (PDB)
- Reduce the memory footprint of the new instance
- Install the latest autoupgrade.jar in the new Oracle Home
...
=================================================================================================
Installing:
oracle-ai-database-preinstall-26ai   x86_64         1.0-1.el8  @commandline                  29 k
...
Running transaction
  Preparing        :                                                                                    1/1 
  Installing       : oracle-ai-database-preinstall-26ai-1.0-1.el8.x86_64                                1/1 
  Running scriptlet: oracle-ai-database-preinstall-26ai-1.0-1.el8.x86_64                                1/1 
  Verifying        : oracle-ai-database-preinstall-26ai-1.0-1.el8.x86_64                                1/1 
...
### Step 2: Locate 26ai software and unzip in the correct location
